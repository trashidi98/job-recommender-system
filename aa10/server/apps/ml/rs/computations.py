...
def bestjobs_computations(resume, city):
    ...
    with open('/Users/saimamunir/Desktop/job-recommender-system-tabish6/aa10/server/apps/ml/rs/model', 'rb') as f:
        lda_model = pickle.load(f)
        
    with open('/Users/saimamunir/Desktop/job-recommender-system-tabish6/aa10/server/apps/ml/rs/jobs', 'rb') as f:
        jobs = pickle.load(f)
